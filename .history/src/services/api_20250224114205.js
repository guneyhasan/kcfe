    ...
    createChallenge: async (challengeData) => {
        try {
            ...
            if (response.data.success) {
                ...
                console.log('Meydan okuma oluşturuldu:', {
                    id: challenge.id,
                    title: challenge.title,
                    game: challenge.game,
                    katılımÜcreti: challenge.financials.entryFee,
                    ödül: challenge.financials.prize,
                    toplamHavuz: challenge.financials.totalPrizePool
                });
                ...
                return {
                    ...
                    data: {
                        challenge: {
                            ...
                            financials: {
                                entryFee: challenge.financials.entryFee,
                                prize: challenge.financials.prize,
                                totalPrizePool: challenge.financials.totalPrizePool
                            },
            ...
            console.error('Meydan okuma oluşturulamadı:', error);
            throw new Error(
                error.response?.data?.message || 
                'Meydan okuma oluşturulurken bir hata oluştu'
            );
        }
    },
                ...
                return {
                    ...
                    data: {
                        request: {
                            ...
                            username: request.username,
                            financials: {
                                entryFee: request.financials.entryFee,
                                prize: request.financials.prize,
                                totalPrizePool: request.financials.totalPrizePool
                            }
                        }
                    }
                };
        ...
        try {
            ...
            if (response.data.success) {
                return {
                    ...
                    data: {
                        match: {
                            id: response.data.data.match.id,
                            game: response.data.data.match.game,
                            host: {
                                id: response.data.data.match.host.id,
                                username: response.data.data.match.host.username,
                                avatarUrl: response.data.data.match.host.avatarUrl,
                                gamerId: response.data.data.match.host.gamerId
                            },
                            opponent: {
                                id: response.data.data.match.opponent.id,
                                username: response.data.data.match.opponent.username,
                                avatarUrl: response.data.data.match.opponent.avatarUrl,
                                gamerId: response.data.data.match.opponent.gamerId
                            },
                            entryFee: response.data.data.match.entryFee,
                            prize: response.data.data.match.prize,
                            pendingTime: response.data.data.match.pendingTime,
                            status: response.data.data.match.status
                        }
                    }
                };
            }
