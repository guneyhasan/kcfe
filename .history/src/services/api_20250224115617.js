                ...
                return {
                    ...
                    data: {
                        match: {
                            ...
                            financials: {
                                entryFee: response.data.data.match.financials.entryFee,
                                prize: response.data.data.match.financials.prize,
                                totalPrizePool: response.data.data.match.financials.totalPrizePool
                            },
