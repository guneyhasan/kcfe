    ...
    getMatchDetails: async (matchId) => {
        try {
            ...
            if (response.data.success) {
                ...
                console.log('API Response:', match); // Debug için
                    ...
                    data: {
                        match: {
                            ...
                            host: {
                                ...
                                gamerId: match.host.gamerId
                            },
                            opponent: {
                                id: match.opponent.id,
                                username: match.opponent.username,
                                avatarUrl: match.opponent.avatarUrl,
                                gamerId: match.opponent.gamerId
                            },
                            entryFee: match.entryFee, // Direkt match objesinden
                            prize: match.prize, // Direkt match objesinden
                            pendingTime: match.pendingTime,
                            status: match.status
                        }
                    }
