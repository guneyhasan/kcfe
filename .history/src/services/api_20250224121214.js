    ...
    getMatchDetails: async (matchId) => {
        try {
            ...
            if (response.data.success) {
                ...
                console.log('Raw API Response:', response.data); // Tüm yanıtı görelim
                ...
                return {
                    ...
                    data: {
                        match: {
                            ...
                            game: matchData.game,
                            host: {
                                username: matchData.host,
                                avatarUrl: matchData.hostAvatarUrl || null,
                                gamerId: matchData.hostGameId || ""
                            },
                            opponent: {
                                username: matchData.opponent,
                                avatarUrl: matchData.opponentAvatarUrl || null,
                                gamerId: matchData.opponentGameId || ""
                            },
