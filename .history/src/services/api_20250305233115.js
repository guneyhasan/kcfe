...
export const challengeService = {
    ...
    declareMatchResult: async (matchId, winnerId) => {
        try {
            const token = challengeService.getToken();
            console.log(`Sonuç bildiriliyor - Match ID: ${matchId}, Winner ID: ${winnerId}`);
            
            // Doğru endpoint: /challenges/matches/{matchId}/result
            const response = await axios.post(
            ...
            console.log('Sonuç bildirimi yanıtı:', response.data);
            return response.data;
        } catch (error) {
                ...
                return {
                    ...
                    data: {
                        match: {
                            ...
                            entryFee: matchData.financials?.entryFee || matchData.entryFee,
                            prize: matchData.financials?.prize || matchData.prize,
