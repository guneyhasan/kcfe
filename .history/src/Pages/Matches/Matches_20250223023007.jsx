...
const Matches = () => {
    ...
    const fetchRequests = async () => {
        try {
            ...
            if (selectedTab === 'gelen' && selectedChallenge) {
                console.log('Gelen istekler getiriliyor, challengeId:', selectedChallenge);
                const requests = await challengeService.getChallengeRequests(selectedChallenge);
                console.log('Gelen istekler:', requests);
    ...
    // Tab değiştiğinde veya seçili meydan okuma değiştiğinde istekleri getir
    useEffect(() => {
        fetchRequests();
