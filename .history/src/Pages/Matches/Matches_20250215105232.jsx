...
const MalarmGelenStekler = () => {
    ...
    const [selectedChallenge, setSelectedChallenge] = useState(null); // Seçili meydan okuma ID'si
    ...
    useEffect(() => {
      async function fetchGelenIstekler() {
        try {
            // Eğer seçili bir meydan okuma varsa
      ...
      if (selectedTab === 'Gelen istekler') {
        fetchGelenIstekler();
      }
        async function fetchGidenIstekler() {
          const fetchedGidenIstekler = [
            {
              id: 1,
              user: {
                username: "@username",
              ...
              reward: "900₺",
              remainingTime: "37 dakika"
            },
            // Diğer giden istekler...
          ];
          setGidenIstekler(fetchedGidenIstekler);
        }
            ...
            <div className={styles.headerMaTekliflerimParent}>
              <div className={styles.headerMaTekliflerim}>
                ...
                <div className={styles.frameGroup}>
                  <div className={styles.gelenIsteklerWrapper} onClick={() => setSelectedTab('gelen')}>
                    <div className={`${styles.gelenIstekler} ${selectedTab === 'gelen' ? styles.activeTab : ''}`}>Gelen istekler</div>
                  </div>
                  <div className={styles.gidenIsteklerWrapper} onClick={() => setSelectedTab('giden')}>
