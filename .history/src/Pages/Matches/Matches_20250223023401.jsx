        ...
        try {
            ...
            if (selectedTab === 'gelen') {
                ...
                if (response.success) {
                    ...
                    // Her meydan okuma için gelen istekleri düzleştir
                ...
                if (response.success) {
                    const { total, requests } = response.data;
                    console.log('Toplam Gönderilen İstek:', total);
                    console.log('Bekleyen İstekler:', requests.pending.length);
                    console.log('Kabul Edilenler:', requests.accepted.length);
        ...
        <div key={request.id} className={styles.tableRow}>
          <div className={styles.cell}>
            <div className={styles.tableuser}>
              <img className={styles.avatarIcon5} alt={} src={request.user.avatar} />
