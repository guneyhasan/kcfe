            						...
            						<div className={styles.headerMaTekliflerimParent}>
              							<div className={styles.headerMaTekliflerim}>
                								...
                								<div className={styles.frameGroup}>
                  									<div className={styles.gelenIsteklerWrapper}>
                    										<div className={styles.gelenIstekler}>Gelen istekler</div>
                  									</div>
                  									<div className={styles.gidenIsteklerWrapper} >
                  									...
                  									<div key={request.id} className={styles.tableRow}>
                    										<div className={styles.cell}>
                      											<div className={styles.tableuser}>
                        												<img className={styles.avatarIcon5} alt={request.user.username} src={request.user.avatarUrl} />
                    										...
                    										<div className={styles.cell}>
                      											<div className={styles.fc25Wrapper}>
                        												<div className={styles.div}>{request.challenge.title}</div>
                      											</div>
                      											<div className={styles.badgeBase4}>
                        												<div className={styles.badgeBase7}>
                          													<img className={styles.avatarIcon8} alt={request.challenge.title} src={request.challenge.status} />
                          													<div className={styles.text3}>{request.challenge.status}</div>
                        												</div>
                      											</div>
                    										</div>
                    										<div className={styles.cell}>
