                ...
                <div className={styles.topContent}>
                    ...
                    <div className={styles.butonParent}>
                        ...
                        <div className={styles.navLinks}>
                            <div 
                                className={`${styles.meydanOkumalarWrapper} ${location.pathname === '/meydanokumalar' ? styles.activeMenuItem : ''}`}
                                onClick={() => navigate('/meydanokumalar')}
                            >
                                <div className={styles.meydanOkumalar}>
                                    <div className={styles.meydanOkumalar1}>Meydan Okumalar</div>
                                </div>
                            </div>
                            <div 
                                className={`${styles.meydanOkumalarWrapper} ${location.pathname === '/matches' ? styles.activeMenuItem : ''}`}
                                onClick={() => navigate('/matches')}
                            >
                                <div className={styles.meydanOkumalar}>
                                    <div className={styles.meydanOkumalar1}>Maçlarım</div>
                                </div>
                            </div>
                            <button
                                type="button"
                            ...
                            <div 
                                className={`${styles.meydanOkumalarWrapper} ${location.pathname === '/kurallar-sss' ? styles.activeMenuItem : ''}`}
                                onClick={() => navigate('/kurallar-sss')}
                            >
                                <div className={styles.meydanOkumalar}>
                                    <div className={styles.meydanOkumalar1}>Kurallar & SSS</div>
                                </div>
                            </div>
                        </div>
                    </div>
