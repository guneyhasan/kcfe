    ...
    useEffect(() => {
        ...
        if (user) {
            setUserData({
                ...
                userId: user.id ? `user id: ${user.id}` : "user id: 123456",
                avatarUrl: user.avatarUrl || "Avatar Single.png"
            });
        }
    }, []);
                    ...
                    <div className={styles.navLinks9}>
                        ...
                        >
                            ...
                            <div className={styles.text}>
                                ...
                                <div className={styles.userId123456}>{userData.userId}</div>
                            </div>
                        </div>
                    </div>
                </div>
