...
const RulesAndFAQPage = () => {
  ...
  return (
    <div className={styles.kurallar}>
      ...
      {!isMobile && <Sidebar defaultActiveTab={5} />}
      
      <div className={styles.container}>
        <PageHeader headerTitle={isMobile ? "Kurallar ve SSS" : "Kurallar ve Sıkça Sorulan Sorular"} 
        ...
        <div className={styles.menuParent}>
          <div className={styles.menu}>
            ...
            >
              <div className={styles.logo}>{isMobile ? "SSS" : "Sıkça Sorulan Sorular"}</div>
            </div>
          </div>
